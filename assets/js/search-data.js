...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Selezione di repository GitHub (progetti personali e didattici).",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-clustering-bayesiano",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%74%6F%6D%6D%61%73%6F%6D%65%6E%67%68%69%6E%69@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/tommaso-menghini-3b99b23a8", "_blank");
        },
      },{
      id: 'light-theme',
